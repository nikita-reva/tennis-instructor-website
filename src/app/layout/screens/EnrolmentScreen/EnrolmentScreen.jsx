                    ...
                    <ContentSection>
                        <StyledFormWrapper>
                            ...
                            <StyledLink>
                                <a
                                    href={
                                        require('../images/tay-anmeldungsformular.pdf')
                                            .default
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    Anmeldungsformular direkt als PDF
                                    herunterladen / ausdrucken
                                </a>
                            </StyledLink>
                            <StyledLink>
                                <Link to="anmeldung/anmeldungsformular/training">
                                    Anmeldungsformular ausfüllen und
                                    herunterladen / ausdrucken
                                </Link>
                            </StyledLink>
                        </StyledFormWrapper>
