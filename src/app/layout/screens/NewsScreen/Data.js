...
export const NewsData = [
    ...
    },
    {
        ...
        imageSlides: [
            {
                image: require('../images/saiten1.jpg').default,
                alt: 'tennis',
            },
            {
                image: require('../images/saiten2.jpg').default,
                alt: 'tennis',
            },
            {
                image: require('../images/saiten3.jpg').default,
                alt: 'tennis',
            },
            {
                image: require('../images/saiten4.jpg').default,
                alt: 'tennis',
            },
        ],
    },
