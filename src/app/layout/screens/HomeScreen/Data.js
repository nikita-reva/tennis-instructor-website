...
export const InfosData = [
    ...
    },
    {
        ...
        text:
            'In der Tennis Academy Yasar bieten wir Ihnen ein breites Sortiment an professionellem Tennis Equipment. Mit unserem Parnter Tecinibre haben wir in unserem Sortiment immer die aktuellen Modelle anzubieten. Gerne stehen wir Ihnen bei der richtigen Auswahl beratend zur Seite.',
        sliderAspectRatio: 1,
        sliderBlackNav: 'true',
        imageSlides: [
            {
    ...
    },
    {
        ...
        image: require('../images/saiten.jpg').default,
        alt: '',
        linkTo: '/kontakt',
